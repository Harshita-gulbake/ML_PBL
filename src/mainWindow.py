...
class mainWindow(customtkinter.CTk):
    ...
    def select_batch(self):
        ...
        class_names = {
            0: "Sugarcane – Yellow Disease",
    1: "Sugarcane – Red Spot Disease",
    2: "Sugarcane – Healthy",
    3: "Maize – Gray Leaf Spot",
    4: "Maize – Rust Disease",
    5: "Maize – Healthy",
    6: "Maize – Leaf Blight",
    7: "Banana – Cordana Disease",
    8: "Banana – Pestalotiopsis Disease",
    9: "Banana – Healthy",
    10: "Banana – Sigatoka Disease"
        }
        ...
        print(f"Total classes detected (without repetition): {total_unique_classes_detected}")
        ...
        prompt = f"""My AI pathology detection model has detected the following diseases ({diseases_detected}):
Caña amarillo corresponds to the fungus Mycovellosiella koepkei, cana punto rojo corresponds to red rot, manchagris is gray leaf spot, roya is rust, tizón is leaf blight, and cordana, pestalotiopsis, and sigatoka are banana fungal diseases.

I need you to recommend treatments, procedures to follow, the level of severity (danger), and methods of prevention for each.
Do it in a technical manner, inserting line breaks every 60 characters.
Do not write a conclusion — at the end, organize the text in the form of a report."""
        ...
        plt.title('Detection Count by Category')
        plt.axis('equal')
        ...
        plt.title('Count of Detections by Class')
        plt.xlabel('Classes')
    ...
    def load_detections(self):
        ...
        headers = ["ID", "Detection Date", "Number of Detections", "No. of Diseases"]
    ...
    def load_charts(self):
        ...
        ax1.axis('equal')
        ax1.set_title("General Distribution by Diseases")
